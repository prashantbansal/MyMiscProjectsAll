...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:asp="http://www.microsoft.com" xmlns:fo="http://www.w3.org/1999/XSL/Format"> 
...
- <!-- Saved Search title
  ...
  <fo:block span="all" font="14pt ARIAL" margin-left="8px" margin-top="8px" color="#000000"><xsl:value-of select="vce/list/document/content/text()"/></fo:block> 
