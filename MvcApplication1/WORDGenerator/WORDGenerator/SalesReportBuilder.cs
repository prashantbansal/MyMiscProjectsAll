...
/// </summary>
public class SalesReportBuilder1
{
    const string drawingTemplate = @"~/resources/drawingTemplate.xml";
    const string headerImageFile = @"~/resources/headerimage.jpeg";
    ...
    public SalesReportBuilder1(string salesPersonID)
    {
        _salesPersonID = salesPersonID;

        //Generate unique filename
        _documentName = "a.docx";
    }
    ...
    /// <summary>
    /// Write the sub title paragraph properties to the WordprocessingML document.
    /// </summary>
    /// <param name="writer">The XmlWriter to write the properties to.</param>
    ...
    /// <summary>
    /// Write the sub title run properties to the WordprocessingML document.
    /// </summary>
    /// <param name="writer">The XmlWriter to write the properties to.</param>
    ...
    /// <summary>
    /// Writes a document contact info within a paragraph
    /// into the WordProcessingML.
    /// </summary>
    /// <param name="writer">The XmlWriter to write the image to.</param>
